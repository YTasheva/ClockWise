...
function ProjectManager({ projects, activeProject, onProjectSelect, onProjectAdded, onProjectDeleted }) {
          ...
          <div key={project.id}>
            {editingId === project.id ? (
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') handleEditProject(project.id, editName);
            ...
            {!project.is_builtin && (
              <div className="project-actions" style={{ display: 'inline-block', marginLeft: '0.5rem' }}>
                <button 
